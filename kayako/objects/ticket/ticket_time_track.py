...
class TicketTimeTrack(KayakoObject):
    ...
    def _parse_ticket_time_track(cls, ticket_time_track_tree, ticket_id):
        ...
        params = dict(
            ...
            workerstaffid=cls._parse_int(
                ticket_time_track_tree.get("workerstaffid")
            ),  #
    ...
    def _update_from_response(self, ticket_time_track_tree):
        ...
        self.workerstaffid = self._parse_int(
            ticket_time_track_tree.get("workerstaffid")
        )
    ...
    def get_all(cls, api, ticketid):
        ...
        return [
            ...
            for ticket_time_track_tree in tree.findall("timetrack")
        ]
    ...
    def add(self):
        ...
        if self.id is not UnsetParameter:
            raise KayakoRequestError(
                "Cannot add a pre-existing %s. (id: %s)"
