...
class TestKayakoAPI(KayakoAPITest):
    ...
    def test__sanitize_paramter_list(self):
        api = self.api
        self.assertEqual(
            api._sanitize_parameter(["a", "b", "", None, "c"]), ["a", "b", "c"]
        )
    ...
    def test_signature(self):
        ...
        import hmac
        import base64
        from urllib3 import request, parse, error
        import hashlib
        ...
        # urlencode...
        url_encoded_signature = parse.quote(encoded_signature)
    ...
    def test_invalid_url(self):
        ...
        api = KayakoAPI(
            "http://this.is.just.a.test.1293847987flsjclksjckn32.com",
            "api_key",
            "secret_key",
        )
        raised = False
